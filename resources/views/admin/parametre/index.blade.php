...
<body>
    ...
    <div class="containers principal">
        ...
        <div id="icone"class="stack">
            ...
            <div id="paramet"><i class="fa-solid fa-gear"></i>Paramètres supplémentaires</div>
        </div>
                ...
                <div id="theme_application" class="stack">
                    <div id="theme_clair">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="350.5" height="317.424" viewBox="0 0 401.5 317.424">
                            <defs>
                    ...
                    <div id="theme_defaut">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="550.211" height="317.041" viewBox="0 0 683.211 317.041">
                            <defs>
                                <clipPath id="clip-path">
                    ...
                    <div id="theme_sombre">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="350.936" height="317.041" viewBox="0 0 400.936 317.041">
                            <defs>
                                <clipPath id="clip-path">
                                    <rect id="Rectangle_205" data-name="Rectangle 205" width="400.064"
                                        height="316.896" fill="none" />
    ...
    <script>
        ...
        var parametre = document.getElementById('paramet');
        var apparences = document.getElementById('apparence_accessibilite');
        var profils = document.getElementById('profils');
        var parametres = document.getElementById('parametsupplementaire');
        ...
        function toggleSection(target, sections) {
            sections.forEach(section => {
                if (section.id === target) {
                    section.elem.style.display = 'flex';
                    section.elem.style.flexDirection = 'column';
                    section.button.style.background = '#e8eaed';
                    section.button.style.borderRadius = '10px';
                    section.button.style.padding = '3px';
                } else {
                    section.elem.style.display = 'none';
                    section.button.style.background = 'none';
                }
            });
        }
        ...
        // Utilisation de toggleSection pour tous les boutons
        apparence.addEventListener('click', () => toggleSection('apparence', sections));
        profil.addEventListener('click', () => toggleSection('profil', sections));
        parametre.addEventListener('click', () => toggleSection('paramet', sections));
    </script>
    <script></script>
